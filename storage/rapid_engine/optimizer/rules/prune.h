...
private:
   ...
   */
  void collect_scan_predicates(PlanNode *node,
   ...
   */
  bool is_column_suitable_for_index(Imcs::RpdTable *rpd_table, 
                                    uint32_t col_idx,
   ...
   */
  void estimate_pruning_benefit(ScanTable *scan,
                                const std::vector<Item*> &predicates);
